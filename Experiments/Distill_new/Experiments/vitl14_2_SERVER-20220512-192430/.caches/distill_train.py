...
parser.add_argument("--teacher", type = str, dest = "tnet", default = "ViT-B/16", help = "Vision model for teacher network")#ViT-L/14
...
for t in range(args.epoch):
    ...
    torch.save({
            ...
            }, './ckpt_sgd_vitl14_2.pth')
torch.save(snet,'./snet_sgd_vitl14_2.pth')
